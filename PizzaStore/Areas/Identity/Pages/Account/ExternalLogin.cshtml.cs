...
namespace PizzaStore.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<PizzaStoreUser> _userStore;
        private readonly IUserEmailStore<PizzaStoreUser> _emailStore;
        ...
        public ExternalLoginModel(
            ...
            IUserStore<PizzaStoreUser> userStore,
        ...
        private PizzaStoreUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(PizzaStoreUser)}'. " +
                    $"Ensure that '{nameof(PizzaStoreUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private IUserEmailStore<PizzaStoreUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<PizzaStoreUser>)_userStore;
        }
    }
}
